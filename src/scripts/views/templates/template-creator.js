...
const createRestaurantDetailTemplate = (restaurant) => `
    <img class="lazyload restaurant-picture" crossorigin="anonymous" alt="${restaurant.name
    ...
    <article class="list-item">
        <a href="#/detail/${restaurant.id || '-'}">
            <div class="list-thumbnail">
                <img class="lazyload list-item-thumbnail" tabindex="0" class="card-image" crossorigin="anonymous" alt="${restaurant.name || '-'
    }" data-src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId || 'https://picsum.photos/id/666/800/450?grayscale'}"/>
